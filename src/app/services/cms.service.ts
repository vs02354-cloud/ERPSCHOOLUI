...
export interface PortalCard { id?: number; title: string; description: string; iconSvg: string; url: string; themeColor: string; displayOrder: number; isActive: boolean; safeIconSvg?: any; }
